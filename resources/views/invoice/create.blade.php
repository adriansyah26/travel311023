                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 margin-tb mt-3 px-4">
                                                <div class="form-group">
                                                    <strong>Total:</strong>
                                                    <input class="form-control" name="total" placeholder="Total" type="number" readonly onkeyup="create();" id="total"></input>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 margin-tb mt-3 px-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 margin-tb mt-3 px-4">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="description" class="form-control" placeholder="Description" value="{{ old('description') }}" required></textarea>
                                                </div>
                                            </div>
                                        </div>
